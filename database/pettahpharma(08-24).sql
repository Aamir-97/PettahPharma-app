...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 24, 2021 at 05:52 PM
...
INSERT INTO `medicalrep` (`rep_ID`, `name`, `display_photo`, `email`, `phone_no`, `area`, `rating`, `password`, `manager_ID`, `created_at`) VALUES
(124, 'Dhiga', NULL, 'dhiga@gmail.com', '0778844556', 'Dehiwala', 'A', 'dhiga', 1, '2021-08-24'),
(125, 'Aamir', NULL, 'aamir@gmail.com', '0768921288', 'Dehiwala', 'A', 'aamir@123', 1, '2021-08-24'),
(146, 'Madhu', NULL, 'madhu@gamil.com', '0758677094', 'Kallaru', '3.5', 'madhu@123', 2, '2021-08-24'),
(164, 'Nimni', NULL, 'nimni@gmail.com', '0778844556', 'Dehiwala', 'A', 'nimni', 2, '2021-08-24');
...
INSERT INTO `salesmanager` (`manager_ID`, `name`, `email`, `phone_no`, `area`, `password`, `created_at`) VALUES
(1, 'Aamir', 'msaaamirali123@gmail.com', '0768921288', 'Maruthamunai', 'Dhiga', '2021-08-24'),
(2, 'Madhu', 'madhu@gmail.com', '0769131669', 'Kalmunai', 'madhu', '2021-08-24'),
(3, 'Thulasi', 'thulasi@gmail.com', '0761122334', 'Jaffna', 'thulasi123', '2021-08-24'),
(4, 'Dini', 'dini@gmail.com', '0769131119', 'Colombo', 'dini', '2021-08-24'),
(5, 'Juz', 'juz@gmail.com', '0778844521', 'Kattankudy', 'Juz', '2021-08-24'),
(6, 'Nimni', 'nimni@gmail.com', '0774411256', 'Galle', 'nimni', '2021-08-24');
...
CREATE TABLE `visit_summary_report` (
  ...
  `product_name` int(255) DEFAULT NULL,
...
INSERT INTO `visit_summary_report` (`report_id`, `visit_type`, `date`, `avg_duration`, `no_of_sample`, `description`, `doctor_name`, `product_name`, `rep_ID`, `manager_ID`, `manager_comment`) VALUES
(1, 'Promotion', '2021-08-15', '1', 50, 'Gave some sample to promote', 1, 2, 125, 2, NULL),
(3, 'Genaral Visit', '2021-06-15', '0.5', NULL, 'Get Feedback', 1, NULL, 125, 2, NULL);
